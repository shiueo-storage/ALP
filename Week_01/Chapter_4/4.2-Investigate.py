...
# Answer: the input number

# Line 8 is changed to total1 = num1 // num2. How would it affect the program?
# Answer: total1 would be changed to the quotient of num1 // num2, so total 3 will be changed too. as it's the substraction of total1 and total2
