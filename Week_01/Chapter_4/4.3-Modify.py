...
mul1 = num1 * num2
print(str(num1) + " times " + str(num2) + " = " + str(mul1))

# Instructions

# Line 4 creates an error. Look carefully to see what is wrong with the code and fix it.
# it's string, not converted to integer type. We need to add int() to make it works correctly
...
# Add a new variable with a sensible identifier.  Multiply num1 and num2 together and assign the result into this
# variable.
