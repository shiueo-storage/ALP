...
number1 = int(input("Please enter a number")) # get input from the user and put it to number1
number2 = int(input("Please enter another number")) # get input from the user and put it to number2

if number1 > number2: # if number1 is greater than number2, print num1 is bigger than num2
