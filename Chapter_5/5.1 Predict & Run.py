...
if age > 18:
    print("You are old enough to drive")  # if age is bigger than 18, it print "You are old enough to drive"
...
if num1 == 10:
    print("This text is output because the condition was true")  # if num1 is 'same' as 10, it print those messages
else:
